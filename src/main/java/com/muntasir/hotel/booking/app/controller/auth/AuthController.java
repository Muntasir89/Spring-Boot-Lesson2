...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<String>> register(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success(null, authResponse));
    ...
    public ResponseEntity<ApiResponse<?>> completeRegistration(
        ...
        try {
            managerRegRequest.setToken(token);
            String authResponse = authService.completeManagerRegistration(managerRegRequest);
            return ResponseEntity.ok(ApiResponse.success(null, authResponse));
        } catch (RuntimeException e) {
